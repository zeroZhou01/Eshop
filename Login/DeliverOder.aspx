<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliverOder.aspx.cs" Inherits="Login_DeliverOder" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1348px">
