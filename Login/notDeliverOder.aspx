<%@ Page Language="C#" AutoEventWireup="true" CodeFile="notDeliverOder.aspx.cs" Inherits="Login_notDeliverOder" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1352px">
